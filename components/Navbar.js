...
import { UserOutlined, CodeOutlined, ShoppingCartOutlined } from '@ant-design/icons'
...
const Navbar = () => {
    return (
        <nav className="fixed top-0 z-50 backdrop-blur-lg rounded-b-2xl w-full flex justify-between items-center h-20 px-4 lg:px-10">
            <div className="">
                <Link href='/'>
                    <h1 className="text-2xl uppercase font-extrabold cursor-pointer">theBootStore.</h1>
                </Link>
            </div>
            <div className="flex">
                <Badge count={5}>
                    <h1 className="text-xl font-bold uppercase flex items-center cursor-pointer bg-secondary p-2 sm:px-4 rounded-2xl"><ShoppingCartOutlined />
